...
| 에러 핸들링 강화 | 🔲 | |
| 앱 내 이용약관/개인정보처리방침 화면 연동 | 🔲 | terms.dart 활용 |
| 음성 데이터 동의 화면 구현 | 🔲 | 첫 업로드 시 표시 |
...
| 음성 파일 | 별도 동의 화면 (audioUploadConsent) |
| 전화번호 (파일명 파싱) | 개인정보 처리 고지 |
| OpenAI/Anthropic 전송 | 제3자 제공 + 국외 이전 동의 |
...
| 주차 | 작업 | 산출물 |
|------|------|--------|
| **1주차** | ~~법적 문서 작성~~ ✅ + 앱 테스트 완료 | 개인정보처리방침, 이용약관, 동의 화면 |
